...
namespace GMCPIL
{
	...
	public weak string DESCRIPTION = "Simple launcher for MCPI-Reborn - GTK+ Edition.";
	public weak string DEFAULT_SERVERS = "thebrokenrail.com\npbptanarchy.tk\n";
	public weak string SERVERS_LABEL = "Each line is an ip:port tuple. If the port is omitted, 19132 is used.";
